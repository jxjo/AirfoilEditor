...
class Bezier: 
    ...
    def _eval_1D (self, pxy, u, der=0):
        ...
        weights = np.asarray(pxy, dtype=float).copy()   # der = 0: weights = points 
        if der > 0:                                     
